...
class BusAPI {
  ...
  /**
   * Given a URL, asynchrnously obtain the HTTP response string
  ...
  /**
   * Return the promised string from CS2030 BUS API given a bus service ID.
   * @param serviceId Bus service id
   * @return The promised string returned by the CS2030 BUS API service listing
  ...
  /**
   * Return the promised string from CS2030 BUS API given a bus stop ID.
